    <div class="mapa">
      <strong><?php echo $DAtos['titulo'];?> </strong>&gt; <a href="<?php echo url_for('asambleas/index?'.$DAtos['get']) ?>">Convocatoria - Asamblea</a> &gt; Editar Asamblea
    </div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="95%"><h1>Ficha de Asamblea - Modificar</h1></td>
