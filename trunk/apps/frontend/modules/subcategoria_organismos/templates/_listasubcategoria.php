<?php
  ...
  use_helper('Javascript');
	...
	echo observe_field($name.'_subcategoria_organismo_id', array('update'=>'content_organismos','url'=>'organismos/listByOrganismoAct','with'=>"'subcategoria_organismos='+value+'&name=".$name."'",'script'   => true));								
?>