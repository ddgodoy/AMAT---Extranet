<h1>
	Novedades<span class="der"><a href="<?php echo url_for('noticias/index') ?>">Ver m&aacute;s novedades</a></span>
</h1>
	...
	<tr class="<?php echo $odd ?>">
		<td align="center" valign="top">
			<?php if ($noticia->getImagen()): ?>
				<img src="<?php echo '/uploads/noticias/images/'.$noticia->getImagen() ?>" width="50" height="50" alt="Noticias" />
			<?php endif; ?>
		</td>
		<td valign="top">
