...
/**
 * SubCategoriaNormativaUno filter form base class.
 *
 * @package    filters
 * @subpackage SubCategoriaNormativaUno *
 * @version    SVN: $Id: sfDoctrineFormFilterGeneratedTemplate.php 11675 2008-09-19 15:21:38Z fabien $
 */
class BaseSubCategoriaNormativaUnoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('sub_categoria_normativa_uno_filters[%s]');
  ...
  {
    return 'SubCategoriaNormativaUno';
  }
