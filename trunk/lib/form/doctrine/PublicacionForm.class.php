...
class PublicacionForm extends BasePublicacionForm
{
  public function configure()
  {
		...
		$this->setValidators(array(
			...
			'fecha_caducidad'   => new sfValidatorDate(array(), array('required' => 'Debes seleccionar una fecha de caducidad', 'invalid' => 'La fecha de caducidad ingresada es incorrecta')),
