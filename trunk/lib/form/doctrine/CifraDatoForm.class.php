  ...
  public function configure()
  {
    ...
    foreach ($selecionar as $r) {
		...
		$this->setWidgets(array(
			...
			'ambito'            => new sfWidgetFormChoice(array('choices' => array('intranet' => 'extranet', 'web' => 'web', 'todos' => 'Intranet y Web'))),
		...
		if($this->getObject()->getImagen())
		{
			...
			$this->setValidator('imagen',new sfValidatorFile(array( 'path' => 'uploads/cifras_datos/images', 'required' => false, 'validated_file_class' => 'sfResizedFile', 'mime_types'=> $img_valids, 'max_size'=>2048000),array('invalid' => 'Invalid file.','mime_types'=>'Formato de imagen incorrecto, permitidos (.jpg, .gif)', 'max_size'=>'Máximo tamaño de imagen: 2 MB')));
