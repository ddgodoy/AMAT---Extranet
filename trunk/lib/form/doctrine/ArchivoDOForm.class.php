...
class ArchivoDOForm extends BaseArchivoDOForm
{
  public function configure()
  {
		...
		{
			$this->setWidget('archivo', new sfWidgetFormInputFileEditable(array('file_src' => 'uploads/archivos_d_o/docs', 'template'  => '<div><label></label>%input%<br /><label></label>%delete%<label> Eliminar documento actual</label></div>', ), array('class' => 'form_input')));
			$this->setValidator('archivo', new sfValidatorFile(array('path' => 'uploads/archivos_d_o/docs', 'required' => false)));
		    $this->setValidator('archivo_delete', new sfValidatorBoolean());
		}
		else 
		{
			
		$this->setWidget('archivo', new sfWidgetFormInputFileEditable(array('file_src' => 'uploads/archivos_d_o/docs', 'template'  => '<div><label></label>%input%<br /><label></label></div>', ), array('class' => 'form_input')));
		$this->setValidator('archivo', new sfValidatorFile(array('path' => 'uploads/archivos_d_o/docs', 'required' => false)));
