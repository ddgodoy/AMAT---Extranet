...
//			'fecha_caducidad' => new sfWidgetFormJQueryDate(array('image'=>'/images/calendario.gif', 'format' => '%day%/%month%/%year%')),
      ...
      'imagen'          => new sfWidgetFormInputFileEditable(array('file_src' => 'uploads/eventos/images','is_image'  => true ,'template'  => '<div><br /><label></label>%input%<br /><label></label>%delete%<label> Eliminar imagen actual</label><br /></div>'), array('class' => 'form_input')),
		...
		$this->setValidators(array(
			...
			'organizador'     => new sfValidatorString(array('max_length' => 255, 'required' => true), array('required' => 'El organizador es obligatorio')),
			'descripcion'     => new sfValidatorString(array('required' => true), array('required' => 'La descripción es obligatoria')),
