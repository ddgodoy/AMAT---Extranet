<tr class="<?php echo $odd ?>">
	<?php if (validate_action('publicar') && $evento->getEstado() == 'pendiente' || validate_action('baja')): ?><td><input type="checkbox" name="id[]" value="<?php echo $evento->getId() ?>" /></td><?php endif;?>
