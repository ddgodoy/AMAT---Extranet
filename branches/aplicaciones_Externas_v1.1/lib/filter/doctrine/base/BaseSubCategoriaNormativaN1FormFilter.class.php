...
/**
 * SubCategoriaNormativaN1 filter form base class.
 *
 * @package    filters
 * @subpackage SubCategoriaNormativaN1 *
 * @version    SVN: $Id: sfDoctrineFormFilterGeneratedTemplate.php 11675 2008-09-19 15:21:38Z fabien $
 */
class BaseSubCategoriaNormativaN1FormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('sub_categoria_normativa_n1_filters[%s]');
