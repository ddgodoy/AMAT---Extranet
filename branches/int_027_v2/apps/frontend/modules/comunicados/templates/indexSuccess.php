...
<div class="mapa"><strong>Comunicados</strong> > </div>
	<table width="100%" cellspacing="0" cellpadding="0" border="0">
		<tbody>
			<tr>
				<td width="70%"><h1>Comunicados</h1></td>
				<td width="5%" align="center"><?php $nombretabla = 'Comunicado'; echo link_to(image_tag('export_exel.jpg', array('title' => 'Exportar exel', 'alt' => 'Exportar exel', 'border' => '0')), 'inicio/exportar?tabla='.$nombretabla.'&filtro='.$sf_context->getModuleName().'_nowfilter&tipo=.xls'); ?></td>
	...
	<div class="leftside">
		<div class="lineaListados">
			...
			<input type="button" onclick="javascript:location.href='<?php echo url_for('comunicados/nueva') ?>';" style="float: right;" value="Nuevo Comunicado" name="newNews" class="boton"/>
			<?php endif;?>
		</div>
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0" class="listados">
			<tbody>
				<tr>
					<th width="10%" style="text-align:left;">
						<a href="<?php echo url_for('comunicados/index?sort=created_at&type='.$sortType.'&page='.$paginaActual.'&orden=1') ?>">Fecha</a>
					</th>
					<th width="20%">
						<a href="<?php echo url_for('comunicados/index?sort=nombre&type='.$sortType.'&page='.$paginaActual.'&orden=1') ?>">Título</a>
					</th>
					<th width="10%">
						<a>Enviado</a>
					</th>
				...
				<?php $i=0; foreach ($comunicado_list as $valor): $odd = fmod(++$i, 2) ? 'blanco' : 'gris' ?>
				<tr class="<?php echo $odd ?>">
					...
					<?php if(validate_action('modificar')):?>
						<a href="<?php echo url_for('comunicados/editar?id=' . $valor->getId()) ?>">
							<strong><?php echo $valor->getNombre() ?></strong>
						</a>
					<?php endif;?>	
					</td>
					<td valign="center">					
						<a><?php if ($valor->getEnviado()): ?>Enviado<?php endif; ?></a>					
					</td>
          ...
          <?php if(validate_action('baja')):?>
          	<?php echo link_to(image_tag('borrar.png', array('title'=>'Borrar','alt'=>'Borrar','width'=>'20','height'=>'20','border'=>'0')), 'comunicados/delete?id='.$valor->getId(), array('method'=>'delete','confirm'=>'Confirma la eliminaci&oacute;n del registro?')) ?>
          <?php endif;?>	
          </td>
				</tr>
				<?php endforeach; ?>
...
<!-- * -->
	<div class="rightside">
		<div class="paneles">
			<h1>Buscar</h1>
			<form method="post" enctype="multipart/form-data" action="<?php echo url_for('comunicados/index') ?>">
				...
				<tbody>
					...
					<td valign="middle">
						<?php echo input_tag('desde_busqueda',
					     $cajaFecBsq,array('onblur'=>"this.style.background='#E1F3F7'","onfocus"=>"this.style.background='#D5F7FF'",'style'=>'width:30%;','class'=>"form_input"))?>
