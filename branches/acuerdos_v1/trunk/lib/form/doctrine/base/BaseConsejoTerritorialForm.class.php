...
/**
 * ConsejoTerritorial form base class.
 *
 * @package    form
 * @subpackage consejo_territorial
 * @version    SVN: $Id: sfDoctrineFormGeneratedTemplate.php 8508 2008-04-17 17:39:15Z fabien $
 */
class BaseConsejoTerritorialForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'            => new sfValidatorDoctrineChoice(array('model' => 'ConsejoTerritorial', 'column' => 'id', 'required' => false)),
