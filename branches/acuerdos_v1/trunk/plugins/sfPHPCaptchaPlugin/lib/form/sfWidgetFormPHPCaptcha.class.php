  ...
  public function render($name, $value = null, $attributes = array(), $errors = array()) {
    ...
    $s .= tag("img",
    					...
    					(
    						...
    						'alt'   => "Captcha picture",
    						'style' => 'vertical-align:middle;border:1px solid #CCCCCC;'
    					)
    				 );
    $s .= content_tag("a", 
    				image_tag($reload_img, array('style'=>'border:none;', 'title'=>'Recargar Caracteres')),
    				array
    				 (
    				  'style' => "position:absolute;margin-left:20px;",
    					'href' => "#",
    					'onclick' => "javascript:document.getElementById('phpcaptcha').src='".url_for('@phpcaptcha_image')."?id='+Math.round(Math.random(0)*1000)+1; return false;"
    				 )
    				);
