		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0" class="listados">
			<tbody>
			    ...
			    <?php
			     ...
			     $colorr = $color=='#EEE'? '#FFF':'#EEE';
			    ?>
			    <?php if(!$menu->getPadreId()):?> 
							    <tr style="background-color:<?php echo  $colorr; ?>;">
							      ...
							      <td valign="top">
									  ...
									  <?php echo link_to(image_tag('borrar.png', array('title' => 'Borrar', 'alt' => 'Borrar', 'width' => '20', 'height' => '20', 'border' => '0')), 'menu/delete?id='.$menu->getId(), array('method' => 'delete', 'confirm' => 'Est&aacute;s seguro que deseas eliminar la menu ' . $menu->getNombre() . '?')) ?>
								    <?php  endif;  ?>
								    </td>
								 </tr>
					 <?php foreach ($menu_list AS $menuHijo):?>
					 <?php if($menuHijo->getPadreId() && $menuHijo->getPadreId() == $menu->getId()):?> 
							    <tr style="background-color:<?php echo $color; ?>;">
							      <td><?php echo $menuHijo->getPosicion()?></td>
							      <td></td><td><span <?php if($menu->getHabilitado()!=1 || $menuHijo->getHabilitado()!=1):?> style="text-decoration: line-through; color: #999;"<?php endif;?>><?php echo $menuHijo->getNombre() ?></span></td>
							      ...
							      <td valign="top">
									  ...
									  <td valign="top">
									  <?php if(validate_action('baja')):?>
									  <?php echo link_to(image_tag('borrar.png', array('title' => 'Borrar', 'alt' => 'Borrar', 'width' => '20', 'height' => '20', 'border' => '0')), 'menu/delete?id='.$menuHijo->getId(), array('method' => 'delete', 'confirm' => 'Est&aacute;s seguro que deseas eliminar la menu ' . $menuHijo->getNombre() . '?')) ?>
								    <?php  endif;  ?>
								    </td>
								 </tr>		 		 
           <?php foreach ($menu_list AS $menuNieto):?>
					 <?php if($menuNieto->getPadreId() && $menuNieto->getPadreId() == $menuHijo->getId()):?> 
							    <tr style="background-color:<?php echo $color; ?>;">
							      <td><?php echo $menuNieto->getPosicion()?></td>
							      <td></td><td></td><td><span <?php if($menu->getHabilitado()!=1 || $menuHijo->getHabilitado()!=1 || $menuNieto->getHabilitado()!=1 ):?> style="text-decoration: line-through; color: #999;"<?php endif;?>><?php echo $menuNieto->getNombre() ?></span></td>
							      <td></td><td valign="top">
									  </td>
							      <td valign="top">
									  <?php if (validate_action('modificar')):?>
									  ...
									  <td valign="top">
									  <?php if(validate_action('baja')):?>
									  <?php echo link_to(image_tag('borrar.png', array('title' => 'Borrar', 'alt' => 'Borrar', 'width' => '20', 'height' => '20', 'border' => '0')), 'menu/delete?id='.$menuNieto->getId(), array('method' => 'delete', 'confirm' => 'Est&aacute;s seguro que deseas eliminar la menu ' . $menuNieto->getNombre() . '?')) ?>
								    <?php  endif;  ?>
								    </td>
								 </tr>		 		 
				   <?php  endif;?>
			...
			<table width="100%" cellspacing="4" cellpadding="0" border="0">
				<tbody>
					...
					Elementos
						...
						<td>
						<div id="elentosid">
							<?php echo include_component('menu','listarElementos')?>
						</div>	
						</td>
					</tr>
					<tr>
					...
					SubElementos
						...
						<td>
						<div id="subelemetos">
							<?php echo include_component('menu','listarSubElementos')?>
						</div>	
						</td>
					</tr>
					<tr>
