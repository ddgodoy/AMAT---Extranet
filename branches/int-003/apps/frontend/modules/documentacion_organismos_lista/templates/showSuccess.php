...
?>
<div class="mapa">
	  <strong>Organismos</strong> > <a href="<?php echo url_for('documentacion_organismos_lista/index') ?>">Documentación</a> > <?php echo  $documentacion_organismo->getNombre() ?>
	</div>
	...
	<div class="botonera">
	  <input type="button" id="boton_cancel" class="boton" value="Volver" name="boton_cancel" onclick="document.location='<?php echo url_for('documentacion_organismos_lista/index?'.$redireccionGrupo) ?>';"/>
	</div>
