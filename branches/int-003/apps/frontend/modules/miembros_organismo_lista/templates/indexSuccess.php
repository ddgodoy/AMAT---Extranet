...
<div class="mapa"><strong>Administraci&oacute;n</strong> > Organismos > Miembros</div>
	...
	<?php  include_component('miembros_organismo_lista','MenuOrganismos',array('id' => $organismosBsq,'modulo'=>$modulo))?>
			...
			<tbody>
				<tr>
					<th width="15%" style="text-align:left;">
						<a href="<?php echo url_for('miembros_organismo_lista/index?sort=u.apellido&type='.$sortType.'&page='.$paginaActual.'&orden=1') ?>">Apellidos</a>
					</th>
					<th width="15%" style="text-align:left;">
						<a href="<?php echo url_for('miembros_organismo_lista/index?sort=u.nombre&type='.$sortType.'&page='.$paginaActual.'&orden=1') ?>">Nombre</a>
					</th>					
					<th width="10%">
						<a href="<?php echo url_for('miembros_organismo_lista/index?sort=u.mutua_id&type='.$sortType.'&page='.$paginaActual.'&orden=1') ?>">Mutua</a>
					</th>
					<th width="30%">
						<a href="<?php echo url_for('miembros_organismo_lista/index?sort=u.email&type='.$sortType.'&page='.$paginaActual.'&orden=1') ?>">Email</a>
					</th>
					<th width="15%">
						<a href="<?php echo url_for('miembros_organismo_lista/index?sort=u.telefono&type='.$sortType.'&page='.$paginaActual.'&orden=1') ?>">Tel&eacute;fono</a>
					</th>

					<th width="30%">
						<a href="<?php echo url_for('miembros_organismo_lista/index?sort=o.grupo_trabajo_id&type='.$sortType.'&page='.$paginaActual.'&orden=1') ?>">Organismo</a>
					</th>
				</tr>
...
<!-- * -->
	<div class="rightside">
		<div class="paneles">
			...
			<form method="post" enctype="multipart/form-data" action="<?php echo url_for('miembros_organismo_lista/index') ?>">
