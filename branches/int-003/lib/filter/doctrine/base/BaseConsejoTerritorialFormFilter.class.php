...
/**
 * ConsejoTerritorial filter form base class.
 *
 * @package    filters
 * @subpackage ConsejoTerritorial *
 * @version    SVN: $Id: sfDoctrineFormFilterGeneratedTemplate.php 11675 2008-09-19 15:21:38Z fabien $
 */
class BaseConsejoTerritorialFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('consejo_territorial_filters[%s]');
  ...
  public function addUsuariosListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query->leftJoin('r.UsuarioConsejoTerritorial UsuarioConsejoTerritorial')
          ->andWhereIn('UsuarioConsejoTerritorial.usuario_id', $values);
  }

  public function getModelName()
  {
    return 'ConsejoTerritorial';
  }
