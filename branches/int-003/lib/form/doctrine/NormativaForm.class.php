  ...
  public function configure()
  {
  	...
  	$this->setWidgets(array(
  	  ...
  	  'publicacion_boe'             => new sfWidgetFormJQueryDate(array('image'=>'/images/calendario.gif', 'format' => '%day%/%month%/%year%','years' => array_combine($years, $years))),
          ...
          'categoria_normativa_id'        => new sfWidgetFormChoice(array('choices' => $categoria), array('style'=>'width: 300px;')),
          'subcategoria_normativa_uno_id' => new sfWidgetFormChoice(array('choices' => $subcategoriaN1), array('style'=>'width: 300px;')),
          'subcategoria_normativa_dos_id' => new sfWidgetFormChoice(array('choices' => $subcategoriaN2), array('style'=>'width: 300px;')),
        ));
