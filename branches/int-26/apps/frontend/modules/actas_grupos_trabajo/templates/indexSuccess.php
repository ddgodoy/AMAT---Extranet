			...
			<tbody>
				<tr>
					<th width="20%" style="text-align:center;">
						<a href="<?php echo url_for('actas_grupos_trabajo/index?'.$DAtos['get'].'&sort=created_at&type='.$sortType.'&page='.$paginaActual.'&orden=1') ?>">Alta</a>
					</th>
					<th width="40%">
						<a href="<?php echo url_for('actas_grupos_trabajo/index?'.$DAtos['get'].'&sort=nombre&type='.$sortType.'&page='.$paginaActual.'&orden=1') ?>">Nombre</a>
					</th>
					<th width="40%">
					<a href="<?php echo url_for('actas_grupos_trabajo/index?'.$DAtos['get'].'&sort=asamblea_id&type='.$sortType.'&page='.$paginaActual.'&orden=1') ?>">Asamblea</a>
					</th>
					<th width="5%">&nbsp;</th>
				</tr>
				...
				<tr class="<?php echo $odd ?>">
					...
					<td valign="top">
						<a href="<?php echo url_for('actas_grupos_trabajo/ver?id=' . $valor->getId().'&'.$DAtos['get']) ?>">
...
<!-- * -->
	<div class="rightside">
		<div class="paneles">
			...
			<form method="post" enctype="multipart/form-data" action="<?php echo url_for('actas_grupos_trabajo/index?'.$DAtos['get']) ?>">
