<div class="mapa">
	...
	<a href="<?php echo url_for('aplicaciones_externas_usuario/index') ?>">Aplicacion Externa de Usuario</a> &gt; 
	Editar
</div>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td width="95%"><h1>Actualizar Datos de Aplicación Externa <?php echo Doctrine::getTable('AplicacionExterna')->find($form->getObject()->getAplicacionExternaId()) ?></h1></td>
