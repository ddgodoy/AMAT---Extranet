...
class sfWidgetFormSelectDoubleList extends sfWidgetForm
{
  ...
  protected function configure($options = array(), $attributes = array())
  {
    ...
    $this->addOption('unassociate', '<img src="'.sfConfig::get('url_web').'/sfFormExtraPlugin/images/next.png" alt="unassociate" border="0" />');
//    $this->addOption('unassociate', '<img src="/sfFormExtraPlugin/images/next.png" alt="unassociate" />');
    $this->addOption('associate', '<img src="'.sfConfig::get('url_web').'/sfFormExtraPlugin/images/previous.png" alt="associate" border="0" />');
