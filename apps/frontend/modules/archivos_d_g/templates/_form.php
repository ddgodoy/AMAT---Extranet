    ...
    <fieldset>
      ...
      <table width="100%" cellspacing="4" cellpadding="0" border="0">
        ...
        <tr>
          ...
          <td><?php echo $form['grupo_trabajo_id'];
                    echo observe_field('archivo_d_g_grupo_trabajo_id', array('update'=>'content_documentacion','url'=>'documentacion_grupos/listByGrupoTrabajo','with'=>"'id_grupo_trabajo='+value"));?> </td>
         <?php /* <td valign="middle">
          	<?php 
			echo select_tag('archivo_d_g[grupo_trabajo_id]',
			options_for_select(array('0'=>'-- seleccionar --') + $arrayGruposTrabajo, $grupos_trabajo_selected),
        ...
        <tr>
          ...
          <td valign="middle">
              <span id="content_documentacion"><?php echo $form['documentacion_grupo_id'];?></span>
          </td>
          <?php /* <td valign="middle">
