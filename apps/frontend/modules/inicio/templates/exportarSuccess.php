		 	  ...
		 	  foreach ($reS AS $hy=>$di)
		 	   {
		 	   	  ...
		 	   	  {
		 	   	    echo '<td>'.utf8_encode(htmlspecialchars_decode(trim(Usuario::datosUsuario($r)))).'</td>';
		 	   	  }
		 	   	  if($hy == 'mutua_id')
		 	   	  {
		 	   	  	if($r>= 1)
		 	   	  	{
		 	   	  	 echo '<td>'.utf8_encode(htmlspecialchars_decode($reS->Mutua->getNombre())).'</td>';
		 	   	  	}
		 	   	  	echo '<td></td>';
		 	   	  ...
		 	   	  if($hy == 'seccion_id')
		 	   	  {
		 	   	  	echo '<td>'.utf8_encode(htmlspecialchars_decode(trim(CifraDatoSeccionTable::getIdseccion($r)))).'</td>';
		 	   	  }
		 	   	  if($hy == 'circular_cat_tema_id')
		 	   	  {
		 	   	  	echo '<td>'.utf8_encode(htmlspecialchars_decode(trim(CircularCatTemaTable::getCircularCat($r)))).'</td>';
		 	   	  }
		 	   	  if($hy == 'grupo_trabajo_id')
		 	   	  {
		 	   	  	echo '<td>'.utf8_encode(htmlspecialchars_decode(trim(GrupoTrabajoTable::getGrupoTrabajo($r)))).'</td>';
		 	   	  }
		 	   	   if($hy == 'categoria_d_g_id')
		 	   	  {
		 	   	  	echo '<td>'.utf8_encode(htmlspecialchars_decode(trim(CategoriaDGTable::getCategoriaDG($r)))).'</td>';
		 	   	  }
		 	   	   if($hy == 'documentacion_grupo_id')
		 	   	  {
		 	   	  	echo '<td>'.utf8_encode(htmlspecialchars_decode(trim(DocumentacionGrupoTable::getDocumentacionGrupoTrabajo($r)))).'</td>';
		 	   	  }
		 	   	   if($hy == 'consejo_territorial_id')
		 	   	  {
		 	   	  	echo '<td>'.utf8_encode(htmlspecialchars_decode(trim(ConsejoTerritorialTable::getConsejo($r)))).'</td>';
		 	   	  }
		 	   	   if($hy == 'categoria_c_t_id')
		 	   	  {
		 	   	  	echo '<td>'.utf8_encode(htmlspecialchars_decode(trim(CategoriaCTTable::getCategoriasCT($r)))).'</td>';
		 	   	  }
		 	   	   if($hy == 'documentacion_consejo_id')
		 	   	  {
		 	   	  	echo '<td>'.utf8_encode(htmlspecialchars_decode(trim(DocumentacionConsejoTable::getDocumentacionConsejo($r)))).'</td>';
		 	   	  }
		 	   	   if($hy == 'aplicacion_id')
		 	   	  {
		 	   	  	echo '<td>'.utf8_encode(htmlspecialchars_decode(trim(AplicacionRolTable::getAplicacionRol($r)))).'</td>';
		 	   	  }
		 	   	  if($hy == 'rol_id')
		 	   	  {
		 	   	  	echo '<td>'.utf8_encode(htmlspecialchars_decode(trim(RolTable::getRol($r)))).'</td>';
		 	   	  }
		 	   	  if($hy == 'categoria_organismo_id')
		 	   	  {
		 	   	  	echo '<td>'.utf8_encode(htmlspecialchars_decode(trim(CategoriaOrganismoTable::getCategoriaOrganismo($r)))).'</td>';
		 	   	  }
		 	   	  if($hy == 'subcategoria_organismo_id')
		 	   	  {
		 	   	  	echo '<td>'.utf8_encode(htmlspecialchars_decode(trim(SubCategoriaOrganismoTable::getSubcategoria($r)))).'</td>';
		 	   	  }
		 	   	  if($hy == 'organismo_id')
		 	   	  {
		 	   	  	echo '<td>'.utf8_encode(htmlspecialchars_decode(trim(OrganismoTable::getOrganismo($r)))).'</td>';
		 	   	  }
		 	   	  if($hy == 'documentacion_organismo_id')
		 	   	  {
		 	   	  	echo '<td>'.utf8_encode(htmlspecialchars_decode(trim(DocumentacionOrganismoTable::getDocumentacionOrganismo($r)))).'</td>';
		 	   	  }
		 	   	  ...
		 	   	  {
		 	        echo '<td>'.utf8_encode(htmlspecialchars_decode(trim($r))).'</td>';
		 	   	  }  
