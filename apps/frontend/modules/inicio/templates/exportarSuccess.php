		 	  ...
		 	  foreach ($reS AS $hy=>$r)
		 	   {
		 	   	  ...
		 	   	  {
                                       if($r){
		 	   	  	echo '"'.utf8_decode(htmlspecialchars_decode(trim($reS->getCategoriaAcuerdo()->getNombre()))).'",';
                                       }else{
                                        echo '"",';
                                       }
		 	   	  }
		 	   	  ...
		 	   	  {
                                       if($r){
		 	   	  	echo '"'.utf8_decode(htmlspecialchars_decode(trim($reS->getSubCategoriaAcuerdo()->getNombre()))).'",';
                                       }else{
                                        echo '"",';
                                       }
		 	   	  }
