						...
						<td width="5%" align="center">
							<?php
								if (validate_action('baja')) {
									echo link_to(image_tag('borrar.png', array('title'=>'Borrar','alt'=>'Borrar','width'=>'20','height'=>'20','border'=>'0')), 'grupos_de_trabajo/delete?id='.$valor->getId(), array('method'=>'delete','confirm'=>'Confirma la eliminaci&oacute;n del registro?'));
								} else {
									echo '&nbsp;';
								}
							?>
