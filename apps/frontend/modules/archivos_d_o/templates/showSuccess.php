...
<div class="mapa">
	...
	<div class="noticias">
	  ...
	  <a href="#" class="nottit"><?php echo  $archivo_do->getNombre() ?></a><br />
	  <?php echo $archivo_do->getcontenido() ?>      
	  <span class="notfecha"><a href="<?php echo url_for('/uploads/archivos_d_o/docs/'.$archivo_do->getArchivo());?>">Documento +</a></span><br />     
