...
<script language="javascript" type="text/javascript" src="/js/calendario/dhtml_calendar.js"></script>
   <div class="mapa">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
     ...
     <?php echo $sf_request->getParameter('Organismos'); exit ();  if(!empty($Organismos) && $sf_request->getParameter('Organismos')== 4): $id_organismos = !empty ($organismomenu)?$organismomenu:''; include_component('miembros_organismo','MenuOrganismos',array('id' => $id_organismos,'modulo'=>$modulo)); endif;?>
