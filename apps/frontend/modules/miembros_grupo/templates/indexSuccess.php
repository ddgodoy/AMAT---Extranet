...
<div class="mapa"><strong>Administraci&oacute;n</strong> > Grupos de Trabajo > Miembros</div>
	<table width="100%" cellspacing="0" cellpadding="0" border="0">
		<tbody>
			<tr>
				<td width="70%"><h1>Miembros de sus Grupos de Trabajo</h1></td>
        ...
        <tbody>
          <tr>
            <th width="15%" style="text-align:left;">
						<a href="<?php echo url_for('miembros_grupo/index?sort=u.apellido&type='.$sortType.'&page='.$paginaActual.'&orden=1') ?>">Apellidos</a>
					</th>
					<th width="15%" style="text-align:left;">
						<a href="<?php echo url_for('miembros_grupo/index?sort=u.nombre&type='.$sortType.'&page='.$paginaActual.'&orden=1') ?>">Nombre</a>
					</th>					
					<th width="10%">
...
<!-- * -->
	<div class="rightside">
		<div class="paneles">
			...
			<form method="post" enctype="multipart/form-data" action="<?php echo url_for('miembros_grupo/index') ?>">
					...
					<tr>
					   <td width="20%">
						...
						<?php  echo select_tag('grupo',
												 options_for_select(array('0'=>'-- seleccionar --') + _get_options_from_objects(GrupoTrabajoTable::getGruposTrabajoByUsuario($sf_user->getAttribute('userId'))), $grupoBsq),
