...
<div class="mapa"><strong>Administraci&oacute;n</strong> > Consejos Territoriales > Miembros</div>
	<table width="100%" cellspacing="0" cellpadding="0" border="0">
		<tbody>
			<tr>
				<td width="70%"><h1>Lista de miembros de sus Consejos Territoriales</h1></td>
	...
	<div class="leftside">
      ...
      <strong class="subtitulo" style="float:left; margin-right:10px; width:auto;">Lista de miembros del Consejo Territorial</strong>
	        ...
	        <tbody>
	          <tr>
	            <th width="15%" style="text-align:left;">
						...
						<th width="15%">
							<a href="<?php echo url_for('miembros_grupo/index?sort=u.telefono&type='.$sortType.'&page='.$paginaActual.'&orden=1') ?>">Teléfono</a>
						</th>
		          </tr>				
