...
<div class="mapa"><strong>Organismos</strong> > Documentación</div>
	...
	<div class="leftside">
		<div class="lineaListados">
			...
			<input type="button" onclick="javascript:location.href='<?php echo url_for('documentacion_organismos/nueva?hola=30') ?>';" style="float: right;" value="Nueva Documentación" name="newNews" class="boton"/>
			<?php endif;?>
		</div>
